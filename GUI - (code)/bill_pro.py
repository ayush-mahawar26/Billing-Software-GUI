...
root.iconbitmap(r'Assets\bill_ZeH_icon.ico')
...
def gr_p():  
    ...
    grom_p.iconbitmap(r'Assets\\trimmer_6a3_icon.ico')
...
def hs_p():
    ...
    hsp_win.iconbitmap('Assets\\hairstyle_JZx_icon.ico')
...
def per_p():
    ...
    perfume.iconbitmap('Assets\\perfume_hWZ_icon.ico')
